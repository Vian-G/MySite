          ...
          <div className="flex flex-col sm:flex-row gap-4 border-t border-border pt-8">
            {isAvailable ? (
              <>
                ...
                >
                  <PhysicalButton variant="graphite" size="md" className="w-full">
                    VIEW RÉSUMÉ PDF ↗
                  </PhysicalButton>
                </a>
                <a 
                  ...
                  className="w-full sm:w-auto"
                >
                  <PhysicalButton variant="metal" size="md" className="w-full">
                    DOWNLOAD RÉSUMÉ PDF ↓
                  </PhysicalButton>
                </a>
              </>
              ...
              <>
                <div className="flex flex-col gap-1 w-full sm:w-auto">
                  <PhysicalButton variant="graphite" size="md" className="w-full opacity-50 cursor-not-allowed" disabled>
                    VIEW RÉSUMÉ PDF ↗
                  </PhysicalButton>
                  <span className="font-mono text-[10px] text-muted-foreground text-center">PDF pending upload</span>
                </div>
                <div className="flex flex-col gap-1 w-full sm:w-auto">
                  <PhysicalButton variant="metal" size="md" className="w-full opacity-50 cursor-not-allowed" disabled>
                    DOWNLOAD RÉSUMÉ PDF ↓
                  </PhysicalButton>
